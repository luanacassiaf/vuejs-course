          ...
          <form @submit.prevent="enviar" @reset.prevent="resetar">
            ...
            <div class="form-group">
              ...
              <select class="form-control" v-model="desenvolvedor.ocupacao">
                ...
                <option v-for="(ocupacao, index) in ocupacoes" :key="index">
                  {{ ocupacao }}
                </option>
              </select>
            </div>
          ...
          <div class="card">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">
                ...
                <ul>
                  <li
                    v-for="(tecnologia, index) in desenvolvedor.tecnologias"
                    :key="index"
                  >
                    {{ tecnologia }}
                  </li>
...
export default {
  ...
  methods: {
    enviar() {
      const formEnviado = Object.assign({}, this.desenvolvedor);
      console.log(formEnviado);
    },
    resetar() {
      this.desenvolvedor = Object.assign({}, this.padrao);
    },
  },
  created() {
    this.resetar();
